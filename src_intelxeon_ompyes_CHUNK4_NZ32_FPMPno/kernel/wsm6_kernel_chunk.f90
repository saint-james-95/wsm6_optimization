...
!
      ...
      real  dt
      real  dzl(1:4,kts:kte),wwl(1:4,kts:kte),rql(1:4,kts:kte),precip(1:4)
      real  denl(1:4,kts:kte),denfacl(1:4,kts:kte),tkl(1:4,kts:kte)
!
...
!
      ...
      integer  its,ite,kts,kte,id
      real  dt
      real  dzl(1:4,kts:kte),wwl(1:4,kts:kte),rql(1:4,kts:kte),rql2(1:4,kts:kte),precip(1:4),precip1(1:4),precip2(1:4)
      real  denl(1:4,kts:kte),denfacl(1:4,kts:kte),tkl(1:4,kts:kte)
!
...
!
  ...
  REAL, DIMENSION( 1:4 , kts:kte ),                           &
        INTENT(INOUT) ::                                          &
                                                               t
  REAL, DIMENSION( 1:4 , kts:kte, 2 ),                        &
        INTENT(INOUT) ::                                          &
                                                             qci
  REAL, DIMENSION( 1:4 , kts:kte, 3 ),                        &
        INTENT(INOUT) ::                                          &
                                                             qrs
  REAL, DIMENSION( 1:4 , kms:kme ),                           &
        INTENT(INOUT) ::                                          &
                                                               q
  REAL, DIMENSION( 1:4 , kms:kme ),                           &
        INTENT(INOUT) ::                                          &
  ...
  REAL, DIMENSION( 1:4 ),                                     &
        INTENT(INOUT) ::                                    rain, &
                                                         rainncv, &
                                                              sr
  REAL, DIMENSION( 1:4, jms:jme ), OPTIONAL,                  &
        INTENT(INOUT) ::                                    snow, &
                                                         snowncv
  REAL, DIMENSION( 1:4, jms:jme ), OPTIONAL,                  &
...
!+---+-----------------------------------------------------------------+
  ...
  ! allocate arrays
  ALLOCATE(t(1:4,kts:kte,jjts:jjte))
  ALLOCATE(qci(1:4,kts:kte,2,jjts:jjte))
  ALLOCATE(qrs(1:4,kts:kte,3,jjts:jjte))
  ALLOCATE(q(1:4,kms:kme,jjms:jjme))
  ALLOCATE(den(1:4,kms:kme,jjms:jjme))
  ALLOCATE(p(1:4,kms:kme,jjms:jjme))
  ALLOCATE(delz(1:4,kms:kme,jjms:jjme))
  ALLOCATE(rain(1:4,jjms:jjme))
  ALLOCATE(rainncv(1:4,jjms:jjme))
  ALLOCATE(sr(1:4,jjms:jjme))
  ALLOCATE(snow(1:4,jjms:jjme))
  ALLOCATE(snowncv(1:4,jjms:jjme))
  ALLOCATE(graupel(1:4,jjms:jjme))
  ALLOCATE(graupelncv(1:4,jjms:jjme))
