...
!
      ...
      real  dt
      real  dzl(1:4,1:32),wwl(1:4,1:32),rql(1:4,1:32),precip(1:4)
      real  denl(1:4,1:32),denfacl(1:4,1:32),tkl(1:4,1:32)
!
...
!
      ...
      integer  its,ite,kts,kte,id
      real  dt
      real  dzl(1:4,1:32),wwl(1:4,1:32),rql(1:4,1:32),rql2(1:4,1:32),precip(1:4),precip1(1:4),precip2(1:4)
      real  denl(1:4,1:32),denfacl(1:4,1:32),tkl(1:4,1:32)
!
...
!
  ...
  REAL, DIMENSION( 1:4 , 1:32 ),                           &
        INTENT(INOUT) ::                                          &
                                                               t
  REAL, DIMENSION( 1:4 , 1:32, 2 ),                        &
        INTENT(INOUT) ::                                          &
                                                             qci
  REAL, DIMENSION( 1:4 , 1:32, 3 ),                        &
        INTENT(INOUT) ::                                          &
                                                             qrs
  REAL, DIMENSION( 1:4 , 1:33 ),                           &
        INTENT(INOUT) ::                                          &
                                                               q
  REAL, DIMENSION( 1:4 , 1:33 ),                           &
        INTENT(INOUT) ::                                          &
...
!+---+-----------------------------------------------------------------+
  ...
  ! allocate arrays
  ALLOCATE(t(1:4,1:32,jjts:jjte))
  ALLOCATE(qci(1:4,1:32,2,jjts:jjte))
  ALLOCATE(qrs(1:4,1:32,3,jjts:jjte))
  ALLOCATE(q(1:4,1:33,jjms:jjme))
  ALLOCATE(den(1:4,1:33,jjms:jjme))
  ALLOCATE(p(1:4,1:33,jjms:jjme))
  ALLOCATE(delz(1:4,1:33,jjms:jjme))
