...
!
  INTEGER,      INTENT(IN   )    ::   ids,ide, jds,jde, kds,kde , &
                                      ...
                                      its,ite, jts,jte, kts,kte,  &
                                      lat
  REAL, DIMENSION( 1:2 , kts:kte ),                           &
        INTENT(INOUT) ::                                          &
                                                               t
  REAL, DIMENSION( 1:2 , kts:kte, 2 ),                        &
        INTENT(INOUT) ::                                          &
                                                             qci
  REAL, DIMENSION( 1:2 , kts:kte, 3 ),                        &
        INTENT(INOUT) ::                                          &
                                                             qrs
  REAL, DIMENSION( 1:2 , kms:kme ),                           &
        INTENT(INOUT) ::                                          &
                                                               q
  REAL, DIMENSION( 1:2 , kms:kme ),                           &
        INTENT(IN   ) ::                                          &
...
!
      ...
      real  dt
      real  dzl(1:2,kts:kte),wwl(1:2,kts:kte),rql(1:2,kts:kte),precip(1:2)
      real  denl(1:2,kts:kte),denfacl(1:2,kts:kte),tkl(1:2,kts:kte)
!
...
!
      ...
      integer  its,ite,kts,kte,id
      real  dt
      real  dzl(1:2,kts:kte),wwl(1:2,kts:kte),rql(1:2,kts:kte),rql2(1:2,kts:kte),precip(1:2),precip1(1:2),precip2(1:2)
      real  denl(1:2,kts:kte),denfacl(1:2,kts:kte),tkl(1:2,kts:kte)
!
...
!+---+-----------------------------------------------------------------+
  ...
  ! allocate arrays
  ALLOCATE(t(1:2,kts:kte,jjts:jjte))
  ALLOCATE(qci(1:2,kts:kte,2,jjts:jjte))
  ALLOCATE(qrs(1:2,kts:kte,3,jjts:jjte))
  ALLOCATE(q(1:2,kms:kme,jjms:jjme))
  ALLOCATE(den(1:2,kms:kme,jjms:jjme))
  ALLOCATE(p(1:2,kms:kme,jjms:jjme))
  ALLOCATE(delz(1:2,kms:kme,jjms:jjme))
