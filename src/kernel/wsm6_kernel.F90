...
!----------------------------------------------------------------
      do k = kts, kte
        ...
        enddo
      enddo
      !print *, "In first slope_wsm6 call", rslope(1,1,1), rslope(2,2,2)
...
! SUBROUTINE SLOPE_RAIN WAS HERE
!------------------------------------------------------------------------------
! SUBROUTINE SLOPE_SNOW WAS HERE
!----------------------------------------------------------------------------------
! REST OF SUBROUTINES IN WSM62D WERE HERE

! SUBROUTINES readarray*() were here
!+---+-----------------------------------------------------------------+
! SUBROUTINES writearray*() were here

! SUBROUTINE firstTouch() WAS HERE
